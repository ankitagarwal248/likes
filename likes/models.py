...
class Campaign(models.Model):
    ...
    link = models.CharField(max_length=255L, null=False, db_index=True, unique=True) 
    title = models.CharField(max_length=1000L)
    description = models.CharField(max_length=1000L)
    keywords = models.CharField(max_length=255L, null=False, db_index=True, unique=True)
